    ...
    RowLayout {
        ...
        FWButton {
            ...
            onButtonClicked: {
                ...
                deleteClicked()
                debugMessage("InfoStudentDetail.qml -> cancelBtn -> onButtonClicked")
            }
        }
...
//        }
        ...
        FWButton {
            id: saveCloseBtn
            text: _optionsRow.editMode ? qsTr("Save & Close") : qsTr("Edit")
            img: _optionsRow.editMode ? "qrc:/Images/ico-confirm.png" : "qrc:/Images/ico-edit.png"
            onButtonClicked: {
                _optionsRow.editMode = !_optionsRow.editMode
                debugMessage("InfoStudentDetail.qml -> saveCloseBtn -> onButtonClicked -> editMode" + _optionsRow.editMode)
            }
        }
