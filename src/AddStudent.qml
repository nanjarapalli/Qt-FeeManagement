...
Rectangle {
    ...
    readonly property string standardClass: _nameInput.text
    readonly property string rollnumber: _nameInput.text
    readonly property string gender: _nameInput.text
    readonly property string dob: _nameInput.text
    readonly property string fatherName: _nameInput.text
    readonly property string motherName: _nameInput.text
    readonly property string mobile: _nameInput.text
    readonly property string regularfee: _nameInput.text
    readonly property string concession: _nameInput.text
    readonly property string finalfee: _nameInput.text
    ColumnLayout {
        id: root
        anchors.fill: parent
        anchors.margins: 10
